...
<p align="center">
  <a target="blank"><img src="https://github.com/snyk04/SurvExp/tree/snyk04/docs/requirements/images"/></a>
</p>
...
**ВИКЛЮЧНІ СИТУАЦІЇ**:
1.	Аналітик перервав процес додавання питання  
...
**ВИКЛЮЧНІ СИТУАЦІЇ**:  
1.	Експерт перервав процес заповнювання анкети  
...
### 4.4 Сценарій авторизації користувача
