...
--- | --- | --- | --- |--- 
Вартість підписки | 499$ - ліцензійна підписка, яка дає доступ до різноманітних бібліотек. | 45/46/117$ для фізичних осіб, 36/89$ для юридичних осіб.  | 0/5.40/10.20/25 $ в залежності від ваших потреб від компанії Google | 
